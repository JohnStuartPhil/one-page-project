...
**Content**
- The website was influenced from the Sample project.
- The code to make the Asterisk wildcard sleector, general styles in the body, Navigation Bar of the CSS and the Social Media links were taken from the Love Running Project and edited accordingly.
